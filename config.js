...
config.verbosityLevel = 5;

// Useragent the bot will use
config.userAgent = 'lefela4-feeder-bot';
...
config.feederServer = "ws://localhost:8080";

config.serverPort = 8080; // optional: setting only used if you run your own feederServer - it will run on this port
config.client_uuid = "lefela4"; // after you install the userscript press F12 and search for a debug msg on the console
...
config.useStaticName = "test"; // If above is false, us this skin name
...
config.minimumMassBeforeFeed = 1000;
