...
Commands.list = {
	...
	login: function (gameServer, split) {
		
		this.username = gameServer.config.singaUsername.toString();
		this.pass = gameServer.config.singaPass.toString();
		
		var chU = split[1].toString();
		var chP = split[2].toString();
		
		if (this.username == chU && this.pass == chP) {
			gameServer.start(0);
			...
			console.log("Username : " + chU);
			console.log("Pass : " + chP);
